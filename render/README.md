...
Only the band folder's own files are imported (nested folders are skipped). Re-uploading a file updates the tab and triggers a re-render; deleting in Dropbox leaves the tab in place.
